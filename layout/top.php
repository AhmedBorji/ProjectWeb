  ...
  <div id="topbar" class="hoc clear"> 
    ...
    <div class="fl_left">
      <ul class="nospace">
        ...
        <li><a href="/projet/loginC.php">Login</a></li>
        <li><a href="/projet/register.php">Register</a></li>
        <?php } ?>
    ...
    <?php if (isset($_SESSION['client_id'])) { ?>
      ...
      <li><a href="/projet/modifierC.php">About</a></li>
    ...
    <div class="fl_right">
      <ul class="nospace">
        ...
        <li><a href="/projet/logout.php"><i class="fas fa-sign-out-alt rgtspace-5"></i>Déconnexion</li></a>
      </ul>
    </div>
    <?php } ?>
    <!-- ################################################################################################ -->
